...
SECURITY_ALERT_NOTIFY_BURST_ENABLED=1
SECURITY_ALERT_NOTIFY_BURST_WINDOW_MS=300000
SECURITY_ALERT_NOTIFY_BURST_THRESHOLD=20
SECURITY_ALERT_NOTIFY_BURST_COOLDOWN_MS=1800000
SECURITY_ALERT_NOTIFY_BURST_REASONS=security.admin.hidden_route_blocked,security.admin.auth_required
...
- 알림 폭주 완화/표시 포맷:
  ...
  - `SECURITY_ALERT_NOTIFY_BURST_ENABLED=1` (기본: ON, 반복 시도 급증 경보)
  - `SECURITY_ALERT_NOTIFY_BURST_WINDOW_MS=300000` (기본: 5분 관측창)
  - `SECURITY_ALERT_NOTIFY_BURST_THRESHOLD=20` (기본: 관측창 내 20회 이상이면 경보)
  - `SECURITY_ALERT_NOTIFY_BURST_COOLDOWN_MS=1800000` (기본: 동일 그룹 재경보 최소 30분 간격)
  - `SECURITY_ALERT_NOTIFY_BURST_REASONS` (기본: 숨김 관리자 경로/관리자 인증필요 이벤트를 급증 감지 대상으로 사용)
